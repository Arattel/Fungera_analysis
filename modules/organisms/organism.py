...
class OrganismFullErrorCorrection(OrganismErrorCorrection, OrganismFull):
    pass


class OrganismFullJumpDirectionIndependent(OrganismJumpDirectionIndependent, OrganismFull):
    pass


class OrganismFullJumpDirected(OrganismJumpDirected, OrganismFull):
    pass
...
if c.instructions_set_name == 'base':
    ...
    organism_class = OrganismFullJumpDirected
elif c.instructions_set_name == 'jump_direction_independent':
    organism_class = OrganismFullJumpDirectionIndependent
elif c.instructions_set_name == 'error_correction':
    organism_class = OrganismFullErrorCorrection
